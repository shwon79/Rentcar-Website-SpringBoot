...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers("/admin/campingcar/**", "/admin/counsel/**", "/admin/discount/**", "/admin/moren/**", "/admin/setting/**", "/admin/popup/**", "/admin/rentcar/**", "/admin/image/**", "/admin/longTerm/**", "/admin/ga/**", "/admin/subscribe/**").hasRole("ADMIN") // ADMIN only
                .and()
                .formLogin()     // 로그인 설정
