...
window.onload = function() {
    ...
    getEditedData('popup1_box1_line4_text3', 'popup1_box1_line4_text3');
    ...
    getEditedData('popup1_box2_line1_price1', 'popup1_box2_line1_price1');
    getEditedData('popup1_box2_line1_text2', 'popup1_box2_line1_text2');
    getEditedData('popup1_box2_line1_price2', 'popup1_box2_line1_price2');
    getEditedData('popup1_box2_line1_text3', 'popup1_box2_line1_text3');
    getEditedData('popup1_box2_line2_title', 'popup1_box2_line2_title');
    getEditedData('popup1_box2_line2_text1', 'popup1_box2_line2_text1');
    getEditedData('popup1_box2_line2_price1', 'popup1_box2_line2_price1');
    getEditedData('popup1_box2_line2_text2', 'popup1_box2_line2_text2');
    getEditedData('popup1_box2_line2_price2', 'popup1_box2_line2_price2');
    getEditedData('popup1_box2_line2_text3', 'popup1_box2_line2_text3');
    getEditedData('popup1_box2_line3_title', 'popup1_box2_line3_title');
    getEditedData('popup1_box2_line3_text1', 'popup1_box2_line3_text1');
    getEditedData('popup1_box2_line3_price1', 'popup1_box2_line3_price1');
    getEditedData('popup1_box2_line3_text2', 'popup1_box2_line3_text2');
    getEditedData('popup1_box2_line3_price2', 'popup1_box2_line3_price2');
    getEditedData('popup1_box2_line3_text3', 'popup1_box2_line3_text3');

    getEditedData('popup1_box2_bottom_line1', 'popup1_box2_bottom_line1');
    getEditedData('popup1_box2_bottom_line2_title', 'popup1_box2_bottom_line2_title');
    getEditedData('popup1_box2_bottom_line2_text1', 'popup1_box2_bottom_line2_text1');
    getEditedData('popup1_box2_bottom_line2_text2', 'popup1_box2_bottom_line2_text2');
    getEditedData('popup1_box2_bottom_line3_title', 'popup1_box2_bottom_line3_title');
    getEditedData('popup1_box2_bottom_line3_text1', 'popup1_box2_bottom_line3_text1');
    getEditedData('popup1_box2_bottom_line3_text2', 'popup1_box2_bottom_line3_text2');
...
function popupEdit() {
    ...
    const popup1_box1_line4_text3 = document.getElementById('popup1_box1_line4_text3').value;
    ...
    let data = {
        "valuesList": [
            ...
            { "title" : "popup1_box1_line4_text3", "value" : popup1_box1_line4_text3 },
