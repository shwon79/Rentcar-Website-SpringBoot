// 캠핑카 예약 등록(campingcar/register), 캠핑카 예약 현황(campingcar/menu) 페이지 기능들

// 캠핑카 예약 등록_campingcar/register
...
// 캠핑카 예약 확정, 확정 취소, 삭제 버튼_campingcar/detail
...
// 대여 날짜 및 시간, 반납 날짜 및 시간 선택시 자동으로 일권, 추가시간 보여주기_campingcar/detail
